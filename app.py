...
st.write("""
This tool allows you to evaluate the potential return on investment from building an AI tool internally, taking into account various factors.
""")
...
CS = st.sidebar.slider("Potential impact on customer satisfaction (CS) on a scale of -10 to 10", -10.0, 10.0, 0.0)
SG = st.sidebar.slider("Alignment with strategic goals (SG) on a scale of -10 to 10", -10.0, 10.0, 0.0)
AR = st.sidebar.slider("Availability of resources (AR) on a scale of -10 to 10", -10.0, 10.0, 0.0)
